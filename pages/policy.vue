<template>
  <main>
    ...
    <Hero :data="heroData" page="main">
      <div class="hero__wrap">
        <div class="container--s u-center">
          ...
          <div class="u-mobile">
              <h2 class="ql-align-center" v-html="mobile_title"></h2> 
          </div>
          <div class="u-desktop">
            <div class="u-font-xl">
    ...
    <div class="official">
      <h2 class="content_title">ONLINE PRIVACY POLICY AGREEMENT</h2>
      <h2>May 1, 2020</h2>
      <p>Sienna Charles, LLC () values its users' privacy. This Privacy Policy ("Policy") will help you understand how we collect and use personal information from those who visit our website or make use of our online facilities and services, and what we will and will not do with the information we collect. Our Policy has been designed and created to ensure those affiliated with Sienna Charles, LLC of our commitment and realization of our obligation not only to meet, but to exceed, most existing privacy standards.</p>
      <p>We reserve the right to make changes to this Policy at any given time. If you want to make sure that you are up to date with the latest changes, we advise you to frequently visit this page. If at any point in time Sienna Charles, LLC decides to make use of any personally identifiable information on file, in a manner vastly different from that which was stated when this information was initially collected, the user or users shall be promptly notified by email. Users at that time shall have the option as to whether to permit the use of their information in this separate manner.</p>
      <p>This Policy applies to Sienna Charles, LLC, and it governs any and all data collection and usage by us. Through the use of www.siennacharles.com, you are therefore consenting to the data collection procedures expressed in this Policy.</p>

      <p>Please note that this Policy does not govern the collection and use of information by companies that Sienna Charles, LLCdoes not control, nor by individuals not employed or managed by us. If you visit a website that we mention or link to, be sure to review its privacy policy before providing the site with information. It is highly recommended and suggested that you review the privacy policies and statements of any website you choose to use or frequent to better understand the way in which websites garner, make use of and share the information collected.</p>
      ...
      <h4><a href="#" title="Information We Collect">Information We Collect</a></h4>
      <p>
      ...
      <p>
        In addition, Sienna Charles, LLC may have the occasion to collect non-personal anonymous demographic information, such as age, gender, household income, political affiliation, race and religion, as well as the type of browser you are using, IP address, or type of operating system, which will assist us in providing and maintaining superior quality service.        
      </p>
      <p>
        Sienna Charles, LLCmay also deem it necessary, from time to time, to follow websites that our users may frequent to gleam what types of services and products may be the most popular to customers or the general public.        
      </p>
      <p>
      ...
      <h4>
        <a href="#" title="Why We Collect Information and For How Long">Why We Collect Information and For How Long</a>
      </h4>
      <p>
      ...
      <h4><a href="#" title="Use of Information Collected">Use of Information Collected</a></h4>
      <p>Sienna Charles, LLC does not now, nor will it in the future, sell, rent or lease any of its customer lists and/or names to any third parties.</p>
      <p>Sienna Charles, LLC may collect and may make use of personal information to assist in the operation of our website and to ensure delivery of the services you need and request. At times, we may find it necessary to use personally identifiable information as a means to keep you informed of other possible products and/or services that may be available to you from www.siennacharles.com</p>
      <p>Sienna Charles, LLC may also be in contact with you with regards to completing surveys and/or research questionnaires related to your opinion of current or potential future services that may be offered.</p>
      <p>Sienna Charles, LLCuses various third-party social media features including but not limited to www.instagram.com/siennacharles and other interactive programs. These may collect your IP address and require cookies to work properly. These services are governed by the privacy policies of the providers and are not within Sienna Charles, LLC's control.</p>

      <h4><a href="#" title="Disclosure of Information">Disclosure of Information</a></h4>
      <p>
        Sienna Charles, LLC may not use or disclose the information provided by you except under the following circumstances:
        <ul class="list_dot">
          ...
          <li>in the aggregate with other information in such a way so that your identity cannot reasonably be
determined;</li>
          ...
          <li>as necessary to maintain, safeguard and preserve all the rights and property of Sienna Charles, LLC.</li>
        </ul>
      </p>

      <h4><a href="#" title="Non-Marketing Purposes">Non-Marketing Purposes</a></h4>
      <p>Sienna Charles, LLC greatly respects your privacy. We do maintain and reserve the right to contact you if needed for non-marketing purposes (such as bug alerts, security breaches, account issues, and/or changes in Sienna Charles, LLC products and services). In certain circumstances, we may use our website, newspapers, or other public means to post a notice.</p>

      <h4><a href="#" title="Children under the age of 13">Children under the age of 13</a></h4>
      <p>Sienna Charles, LLC's website is not directed to, and does not knowingly collect personal identifiable information from, children under the age of thirteen (13). If it is determined that such information has been inadvertently collected on anyone under the age of thirteen (13), we shall immediately take the necessary steps to ensure that such information is deleted from our system's database, or in the alternative, that verifiable parental consent is obtained for the use and storage of such information. Anyone under the age of thirteen (13) must seek and obtain parent or guardian permission to use this website.</p>

      <h4><a href="#" title="Unsubscribe or Opt-Out">Unsubscribe or Opt-Out</a></h4>
      <p>All users and visitors to our website have the option to discontinue receiving communications from us by way of email or newsletters. To discontinue or unsubscribe from our website please send an email that you wish to unsubscribe to info@siennacharles.com. If you wish to unsubscribe or opt-out from any third-party websites, you must go to that specific website to unsubscribe or opt-out. Sienna Charles, LLC will continue to adhere to this Policy with respect to any personal information previously collected.</p>

      <h4><a href="#" title="Links to Other Websites">Links to Other Websites</a></h4>
      <p>Our website does contain links to affiliate and other websites. Sienna Charles, LLC does not claim nor accept responsibility for any privacy policies, practices and/or procedures of other such websites. Therefore, we encourage all users and visitors to be aware when they leave our website and to read the privacy statements of every website that collects personally identifiable information. This Privacy Policy Agreement applies only and solely to the information collected by our website.</p>

      <h4><a href="#" title="Notice to European Union Users">Notice to European Union Users</a></h4>
      <p>Sienna Charles, LLC's operations are located primarily in the United States. If you provide information to us, the information will be transferred out of the European Union (EU) and sent to the United States. (The adequacy decision on the EU-US Privacy became operational on August 1, 2016. This framework protects the fundamental rights of anyone in the EU whose personal data is transferred to the United States for commercial purposes. It allows the free transfer of data to companies that are certified in the US under the Privacy Shield.) By providing personal information to us, you are consenting to its storage and use as described in this Policy</p>

      <h4><a href="#" title="Security">Security</a></h4>
      <p>Sienna Charles, LLC takes precautions to protect your information. When you submit sensitive information via the website, your information is protected both online and offline. Wherever we collect sensitive information (e.g. credit card information), that information is encrypted and transmitted to us in a secure way. You can verify this by looking for a lock icon in the address bar and looking for "https" at the beginning of the address of the webpage.</p>
      ...
      <p>The company also uses Secure Socket Layer (SSL) for authentication and private communications to build users' trust and confidence in the internet and website use by providing simple and secure access and communication of credit card and personal information. In addition, Sienna Charles, LLC is a licensee of TRUSTe. The website is also secured by VeriSign.</p>

      <h4><a href="#" title="Acceptance of Terms">Acceptance of Terms</a></h4>
      ...
      <h4><a href="#" title="How to Contact Us">How to Contact Us</a></h4>
      ...
      <h5>Email:<span style="margin-left:10px;">info@siennacharles.com</span></h5>
      <h5>Mailing Address: <span style="margin-left:10px;">325 N Maple Drive, #15483 Beverly Hills, CA 90210</span></h5>
      <h5>Sienna Charles, LLC</h5>
...
<script>
import backgroundUrl from "@/assets/images/main_bg.jpg";
export default {
  name: "privacy-policy",
